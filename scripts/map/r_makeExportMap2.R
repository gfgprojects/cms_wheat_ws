...
edges.data<-read.csv("wheat_gephi_edges_2010.csv")
...
for(iso in linked){
	...
	write(paste("{label: \"Commercial Relationships (",buyers.data$Country[which(buyers.data$ISO3.Code==iso)],")\",left: 50,top: 40,color: \"",color,"\",","labelColor: \"",color,"\",","labelRollOverColor: \"",color,"\",labelFontSize: 16},",sep=""),fileName,append=T)
