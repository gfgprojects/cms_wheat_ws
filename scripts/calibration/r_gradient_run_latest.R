...
for(ite in 1:1){
	...
	write(first.str,"/Users/giulioni/Documents/workspace_cms/cms_wheat/data/producers.csv")
	write(file.buyers[1],"/Users/giulioni/Documents/workspace_cms/cms_wheat/data/buyers.csv")
	write(file.food[1],"/Users/giulioni/Documents/workspace_cms/cms_wheat/data/buyers_Food.csv")
	write(file.feed[1],"/Users/giulioni/Documents/workspace_cms/cms_wheat/data/buyers_Feed.csv")
	write(file.seed[1],"/Users/giulioni/Documents/workspace_cms/cms_wheat/data/buyers_Seed.csv")
	...
	write(first.str,"/Users/giulioni/Documents/workspace_cms/cms_wheat/data/buyers_Misc.csv")
	for(i in 1:nrow(production)){
		if(maximums.excess[i]>0){
			...
			write(str.joined,"/Users/giulioni/Documents/workspace_cms/cms_wheat/data/producers.csv",append=T)

			write(file.buyers[i+1],"/Users/giulioni/Documents/workspace_cms/cms_wheat/data/buyers.csv",append=T)

			str.p1<-paste(data.food[i,1],data.food[i,2],data.food[i,3],data.food[i,4],sep=",")
			str.p2<-paste(food[i,],collapse=",")
			str.joined<-paste(str.p1,str.p2,sep=",")
			write(str.joined,"/Users/giulioni/Documents/workspace_cms/cms_wheat/data/buyers_Food.csv",append=T)
			...
			str.joined<-paste(str.p1,str.p2,sep=",")
			write(str.joined,"/Users/giulioni/Documents/workspace_cms/cms_wheat/data/buyers_Feed.csv",append=T)	
			...
			str.joined<-paste(str.p1,str.p2,sep=",")
			write(str.joined,"/Users/giulioni/Documents/workspace_cms/cms_wheat/data/buyers_Seed.csv",append=T)	
			...
			str.joined<-paste(str.p1,str.p2,sep=",")
			write(str.joined,"/Users/giulioni/Documents/workspace_cms/cms_wheat/data/buyers_Misc.csv",append=T)
		}
	}
	for(i in 1:nrow(production)){
		if(maximums.excess[i]<=0){
	...
	write("","/Users/giulioni/Documents/workspace_cms/cms_wheat/data/producers.csv",append=T)
	write("","/Users/giulioni/Documents/workspace_cms/cms_wheat/data/buyers.csv",append=T)
	write("","/Users/giulioni/Documents/workspace_cms/cms_wheat/data/buyers_Feed.csv",append=T)
	write("","/Users/giulioni/Documents/workspace_cms/cms_wheat/data/buyers_Food.csv",append=T)
	write("","/Users/giulioni/Documents/workspace_cms/cms_wheat/data/buyers_Seed.csv",append=T)
	write("","/Users/giulioni/Documents/workspace_cms/cms_wheat/data/buyers_Misc.csv",append=T)

	system("rm output/z*")
	system("./run_batch")

	source("r_gradient_move_multipliers.R")
