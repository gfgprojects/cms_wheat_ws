...
str1<-system("grep startUsingInputsFromTimeTick= /home/ggiulioni/Documents/workspace_cms/cms_wheat/src/cms_wheat/Cms_builder.java",intern=T)
...
food<-read.csv("/home/ggiulioni/Documents/workspace_cms/cms_wheat/data/buyers_Food.csv",)
