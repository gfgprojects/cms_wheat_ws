...
%	\includegraphics[width=0.15\textwidth]{example-image-1x1}\par\vspace{1cm}
	\begin{center}
	{\color{blue}\scshape\Huge CMS-Wheat \par}
	\end{center}
	...
	{\color{blue}\scshape\Huge -W\LARGE heat}\\
...
\subsection{CMS-Wheat}

CMS-Wheat has to be installed as an eclipse RS project. We will give hereafter the instructions to achieve this goal.
...
Create a new RS project called \verb+cms_wheat+ (file $\rightarrow$ new $\rightarrow$ Repast Simphony project)

This creates the \verb+cms_wheat+ folder and a series of sub folders inside the workspace:

The following figure show the \verb+cms_wheat+ rs project folders tree.
...
\vskip2mm
Now, the \verb+cms_wheat+ files have to be added to the just created RS project folders tree.
...
So, let us show how to fetch the \verb+csm_wheat+ files via git. To do that, you must have a git client installed in your system. Many system comes with a git client already installed, otherwise you have to install it. Mac and windows users can consider to install the GitHub Desktop software.
...
If your check is successful, change directory to the \verb+cms_wheat+ project folder:\\
\verb+cd /Users/coolcoder/Documents/workspace/cms_wheat+\\
and type the following commands:
\begin{verbatim}
git init
git remote add origin https://github.com/gfgprojects/cms_wheat.git
...
Now, the \verb+cms_wheat+ files should show up in the RS project folders.
Refresh the \verb+cms_wheat+ RS project with the navigation tab selected in the side bar (file $\rightarrow$ refresh) to make them visible in eclipse.
...
\verb+https://github.com/gfgprojects/cms_wheat+\\
Click on the ``clone or download'' button and choose ``download zip''.

This will download the \verb+cms_wheat-master.zip+ file in your system.

Unpacking it creates the cms\_wheat-master folder.
Move the whole content of this folder in the cms\_wheat RS project folder:\\  
\verb+/Users/coolcoder/Documents/workspace/cms_wheat/+\\
